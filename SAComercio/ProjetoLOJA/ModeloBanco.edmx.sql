...
-- --------------------------------------------------
-- Date Created: 07/16/2018 19:16:21
-- Generated from EDMX file: C:\Users\wesley.lbsilva\source\Workspaces\ProjetoLoja\ProjetoLOJA\ModeloBanco.edmx
-- --------------------------------------------------
...
IF OBJECT_ID(N'[dbo].[FK__Pedidos__Cliente__6A30C649]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Pedidos] DROP CONSTRAINT [FK__Pedidos__Cliente__6A30C649];
GO
...
-- Creating foreign key on [Clientes] in table 'Pedidos'
ALTER TABLE [dbo].[Pedidos]
ADD CONSTRAINT [FK__Pedidos__Cliente__6A30C649]
...
-- Creating non-clustered index for FOREIGN KEY 'FK__Pedidos__Cliente__6A30C649'
CREATE INDEX [IX_FK__Pedidos__Cliente__6A30C649]
ON [dbo].[Pedidos]
    ([Clientes]);
GO
